...
class CreateAvailabilitiesForMultipleDaysNewTest extends TestCase
{
    /**
     * @param string[] $values
    ...
    public function testMultiple(array $values, Carbon $startingDate, array $expectedAvailabilities) {
        ...
        $availabilities = $scheduleParser->createAvailabilitiesForMultipleDayNew($values, $startingDate);
