...
class PreferedScheduleParseNewTest extends TestCase
{
    ...
    public function testParse(
        ...
        $scheduleParser->setParserVersion(2);
        ...
        return [
            ...
            'test3 far availability ' => [
                ...
                'checkAvailabilityParams' => [
                    ...
                    ['name' => 'Aurelija Krikštaponienė', 'date' => '2022-12-10T20:00:00'],
                ],
                'expectedAvailabilities' => [
                    (new Availability())
                    ...
                    (new Availability())
                    ->setDate('2022-12-10T20:00:00')
                    ->setDateTill('2022-12-11T08:00:00')
                    ->setAvailabilityType(Availability::DESIRED)
                    ->setEmployee(
                        (new Employee())
                            ->setName('Aurelija Krikštaponienė')
