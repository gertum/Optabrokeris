...
class CreateAvailabilitiesForOneDayNewTest extends TestCase
{
    ...
    public function testCreateAvailabilities(string $availabilityValue, Carbon $currentDay, array $expectedAvailabilities) {
        ...
        $availabilities = $scheduleParser->createAvailabilitiesForOneDayNew($availabilityValue, $currentDay);
